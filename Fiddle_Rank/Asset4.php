...
<div class="row">
 ...
 <div class="container-fluid" id="question">
  <h5 id="questionname">String Palindrome</h5>
...
var inputcases=new Array("vyyv","nn","etsunjknuste","askdlsa ","abcdcba");
var outputcases=new Array("true","true","false","false","true");
var results=[];
var tee="";
  function runcases(i){

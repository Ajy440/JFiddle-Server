...
<div class="row">
 ...
 <div class="container-fluid" id="question">
  <h5 id="questionname">Maximum in Array</h5>
  Given an Integer array of size 'n', where n>=100.   
  Find the maximum element from the array and print the result.
...
var inputcases=new Array("5 1 9 3 4 5","5 1 9 3 10 5","5 1 9 12 4 5","5 1 20 3 4 5","5 22 9 3 4 5");
var outputcases=new Array("9","10","12","20","22");
var results=[];
var tee="";
  function runcases(i){

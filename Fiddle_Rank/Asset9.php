...
<div class="row">
 ...
 <div class="container-fluid" id="question">
  <h5 id="questionname">String Manipulation</h5>
 Manipulate String as per given rules.<br>
Replace all occurence of vowels with "*"<br>
Replace all occurence of spaces with  "%"<br>
Print the string after manipulation.
...
var inputcases=new Array("Hello how are you?","I am fine","Welcome ","aeiou uoiea"," hope");
var outputcases=new Array("H*ll*%h*w%*r*%y**?","*%*m%f*n*","W*lc*m*%","***** *****","%h*p*");
var results=[];
var tee="";
  function runcases(i){
